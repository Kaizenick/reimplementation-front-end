    ...
    alternatives: Yup.string().when("question_type", ([questionType], schema) => {
      if (questionType === "dropdown" || questionType === "multiple_choice") {
        return schema
          ...
          .test("min-2-options", "Enter at least two options, separated by commas.", (value) => {
          ...
          <Form>
              ...
              <div className="mb-3">
                ...
                {values.relatesToRole && (
                  <div>
                    ...
                    <Field as="select" name="selectedDuty" className="form-control mt-1">
                    ...
                    <ErrorMessage name="selectedDuty" component="div" className="text-danger" />
                  </div>
                )}
              </div>
            )}
            ...
            <div className="d-flex align-items-center mt-1 mb-1">
              <div
                ...
                title="Make questionnaire private, so other instructors cannot see it"
              >
            ...
            <QuestionnaireItemsFieldArray
              ...
              errors={errors}
              touched={touched}
              itemTypes={(itemTypes?.data?.map((t: any) => t.name) as string[]) ?? []}
            />
