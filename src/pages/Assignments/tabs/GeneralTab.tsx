          ...
          */}
          <div className="col-md-6">
            ...
            <div className="form-check mb-3">
              <input
                type="checkbox"
                id="assignment-show_teammate_review"
                name="show_teammate_review"
                className="form-check-input"
              />
              <label htmlFor="assignment-show_teammate_review" className="form-check-label">
            ...
            <div className="form-check mb-3">
              <input
                type="checkbox"
                id="assignment-use_bookmark"
                name="use_bookmark"
                className="form-check-input"
              />
              <label htmlFor="assignment-use_bookmark" className="form-check-label">
                Use Bookmark
              </label>
            </div>
            <div className="form-check mb-3">
