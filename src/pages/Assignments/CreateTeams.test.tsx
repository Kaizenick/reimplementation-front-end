...
describe("Test Create Teams Displays Correctly", () => {
  it("Renders the component correctly as an assignment", async () => {
    await act(async () => {
      renderWithRouter(
        <CreateTeams />,
        assignmentContext.contextType,
        assignmentContext.contextName
      );
    });
...
describe.skip("Test Create Teams Functions Correctly", () => {
  ...
  it("Test Edit Team Name", async () => {
    ...
    act(() => {
      ...
      const editButton = within(team.parentElement?.parentElement).getByRole("button", {
        name: "edit",
      });
      editButton.click();
    });
  ...
  it("Test Removing a Team", async () => {
    ...
    act(() => {
      if (!team.parentElement?.parentElement) fail();
      const deleteButton = within(team.parentElement?.parentElement).getByRole("button", {
        name: "delete",
      });
      deleteButton.click();
    });
  ...
  it("Test Showing All Unassigned Users", async () => {
    ...
    participantData.forEach((participant) => {
      expect(
        within(within(unassignedTabPanel).getByTestId("student-list")).getByText(
