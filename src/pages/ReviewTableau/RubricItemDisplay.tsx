 ...
 */
export const RubricItemDisplay: React.FC<RubricItemDisplayProps> = ({ item, isHeader = false }) => {
          ...
          >
            <div style={{ flex: 1, marginRight: "10px" }}>
              <div className="item-number-with-weight">
                {item.questionNumber && <span className="item-number">{item.questionNumber}.</span>}
                <span>{item.txt}</span>
              </div>
            ...
            {item.maxScore && <MaxScoreWidget maxScore={item.maxScore} />}
          </div>
        );
        ...
        return (
          ...
          >
            ...
            {item.options && item.options.length > 0 && (
              <div
                style={{ fontSize: "11px", color: "#888", marginTop: "2px", marginLeft: "15px" }}
              >
